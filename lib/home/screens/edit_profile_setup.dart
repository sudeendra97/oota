...
class EditProfileSetUp extends StatefulWidget {
  EditProfileSetUp({Key? key}) : super(key: key);

  static const routeName = '/EditProfileSetUp';
...
class _EditProfileSetUpState extends State<EditProfileSetUp> {
  ...
  Future<void> getProfileDetails() async {
    ...
    firstNameController.text = extratedUserData['First_Name'];
    lastNameController.text = extratedUserData['Last_Name'];
    mobileController.text = extratedUserData['Mobile'];
    consumerAddressController.text = extratedUserData['Street'];
    cityController.text = extratedUserData['City'];
    // zipCodeController.text = extratedUserData['Zip_Code'];
    stateController.text = extratedUserData['State'];
    userProfileSetUp['Latitude'] = extratedUserData['Latitude'];
    userProfileSetUp['Longitude'] = extratedUserData['Longitude'];
    userProfileSetUp['Profile_Code'] = extratedUserData['Profile_Code'];
    print(extratedUserData['Latitude'].toString());
    print(extratedUserData['Longitude'].toString());
    print(extratedUserData['Profile_Code'].toString());
    _consumerId = extratedUserData['Consumer_Id'];
        ...
        if (value['Status_Code'] == 200 || value['Status_Code'] == 201) {
          ...
          Provider.of<ApiCalls>(context, listen: false)
            ...
            if (value['StatusCode'] == 202) {
              EasyLoading.showSuccess('Successfully Updated Your Profile');
